...
int main(){
   ...
   devices = (cl_device_id*) malloc(sizeof(cl_device_id) * deviceCount);
    ...
    ext::AnimatedSFE_MOVIES mymusic(MATHS_MUSIC_INDEX);
    ...
    while(window->isOpen()){
            ...
            switch(event.type){
                ...
                case sf::Event::KeyPressed:
                    if (event.key.code == sf::Keyboard::Escape){
                        ...
                        else if (event.key.code == sf::Keyboard::R ) { //Volume +
                ...
                case sf::Event::MouseButtonPressed:
                    ...
                    /*if ( SHOW_ANIMED_SFE_MOVIES_VIDEO ){
                        int xPos = 0;
                ...
                case sf::Event::MouseMoved:
                    ...
                    /*if ( SHOW_ANIMED_SFE_MOVIES_VIDEO && sf::Mouse::isButtonPressed(sf::Mouse::Left)  ){
                        int xPos = 0;
        ...
        if ( SHOW_CENTER_MENU_SPRITE ){ ext_cent_menu.draw( window ); }
        ...
        window->draw(anim_movies.button_video_share_screen_vertically);
        window->draw(anim_movies.button_video_share_screen_horizontally);
